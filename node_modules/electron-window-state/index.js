...
module.exports = function (options) {
  ...
  state = objectAssign({
    ...
    // bug hotfix IGOR IVANIC -- 22.7.2016 - when config file does not exists, x and y are not mainteined which couses(x and y are needed for validateState())
    // Maximaze state(and other) not restoring.
    // this bugfix will work with datachief, but may not work in other usage scenarios
    x: config.x || 0,
    y: config.y || 0
  }, state);
